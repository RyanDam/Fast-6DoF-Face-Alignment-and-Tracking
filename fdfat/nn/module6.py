...
class MainStreamModule(nn.Module):
    ...
    def __init__(self, expand_rate=2, muliplier=1, act=True):
        ...
        self.convp21 = Conv(int(64*muliplier), int(64*muliplier), k=3, s=2, act=self.act)
        self.convp22 = C2f(int(64*muliplier), int(96*muliplier), act=self.act)
    ...
    def forward(self, x):
        ...
        stage_2f = self.global_pool(stage_2).flatten(start_dim=1)
        ...
        x = self.concat([stage_2f, x2f, x3f])
